...
const ROWS = ['W1:', 'W2:', 'W3:', 'W4:', 'EXT DYS:'];

export default function QuarterlyView() {
    const [data, setData] = useLocalStorage<Record<string, string>>('quarterlySchedule', {});
    ...
    return (
        <div className={styles.container}>
            <div className={styles.header}>
                QUARTERLY SCHEDULE (Schedule Tasks here, prioritise Top 3)
            </div>
